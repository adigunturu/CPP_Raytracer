...
* -> main(): Defines image and quality properties and initialiazes camera, world, and writes rendered framebuffer to render.ppm
* -> ray_color(): Returns the color calculated by the ray coming from the camera through the pixel.
* -> random_scene(): Returns a list of hittable objects generated procedurally.
*/
...
Color ray_color(const Ray& ray, const Color& background,const Hittable& world, int depth) //DECIDES COLOR ON A RAYTRACE
{
